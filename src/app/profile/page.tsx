            ...
            <div className="glass space-y-6 border border-[color:var(--surface-border)] p-8 rounded-2xl shadow-lg">
              ...
              {!myStatus && myListings.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-secondary mb-4">Start building your portfolio by creating new listings.</p>
                  <Link href="/agent/upload" className="btn btn-primary">Create New Listing</Link>
                </div>
              )}
          ...
          {isAgent && activeSection === 'shortcuts' && (
            <div className="glass space-y-6 border border-[color:var(--surface-border)] p-8 rounded-2xl shadow-lg">
              ...
              <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
                ...
                <Link href="/agent/my-listings" className="btn btn-secondary p-4 text-center">
                  <svg className="h-6 w-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                  My Listings
          ...
          <div className="sticky top-28 space-y-6">
            <div className="glass space-y-4 border border-[color:var(--surface-border)] p-6 rounded-2xl shadow-lg">
              ...
              <div className="space-y-3">
                ...
                {isAgent ? (
                  <Link href="/agent/my-listings" className="btn btn-secondary w-full justify-start">
                    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
                    My Listings
